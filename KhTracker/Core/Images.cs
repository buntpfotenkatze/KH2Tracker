...
public partial class MainWindow
{
    ...
    public static bool CustomLevelFound;
    public static bool CustomStrengthFound;
    public static bool CustomMagicFound;
    public static bool CustomDefenseFound;
    public static bool CustomProgFound;
    ...
    public void InitImages()
    {
        ...
        cusItemCheck = new Dictionary<Item, Tuple<string, Item, ContentControl, string>>
        {
            {
                Report1,
                new Tuple<string, Item, ContentControl, string>(
                    "Cus-Report1",
                    Ghost_Report1,
                    S_Report1,
                    "CustomImages/Checks/ansem_report01.png"
                )
            },
            {
                Report2,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Report2,
                    S_Report2,
                    "CustomImages/Checks/ansem_report02.png"
                )
            },
            {
                Report3,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Report3,
                    S_Report3,
                    "CustomImages/Checks/ansem_report03.png"
                )
            },
            {
                Report4,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Report4,
                    S_Report4,
                    "CustomImages/Checks/ansem_report04.png"
                )
            },
            {
                Report5,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Report5,
                    S_Report5,
                    "CustomImages/Checks/ansem_report05.png"
                )
            },
            {
                Report6,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Report6,
                    S_Report6,
                    "CustomImages/Checks/ansem_report06.png"
                )
            },
            {
                Report7,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Report7,
                    S_Report7,
                    "CustomImages/Checks/ansem_report07.png"
                )
            },
            {
                Report8,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Report8,
                    S_Report8,
                    "CustomImages/Checks/ansem_report08.png"
                )
            },
            {
                Report9,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Report9,
                    S_Report9,
                    "CustomImages/Checks/ansem_report09.png"
                )
            },
            {
                Report10,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Report10,
                    S_Report10,
                    "CustomImages/Checks/ansem_report10.png"
                )
            },
            {
                Report11,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Report11,
                    S_Report11,
                    "CustomImages/Checks/ansem_report11.png"
                )
            },
            {
                Report12,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Report12,
                    S_Report12,
                    "CustomImages/Checks/ansem_report12.png"
                )
            },
            {
                Report13,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Report13,
                    S_Report13,
                    "CustomImages/Checks/ansem_report13.png"
                )
            },
            {
                Fire1,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Fire1,
                    S_Fire,
                    "CustomImages/Checks/magic_fire.png"
                )
            },
            {
                Fire2,
            ...
            },
            {
                ...
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Blizzard1,
                    S_Blizzard,
                    "CustomImages/Checks/magic_blizzard.png"
                )
            },
            {
                Blizzard2,
            ...
            },
            {
                ...
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Thunder1,
                    S_Thunder,
                    "CustomImages/Checks/magic_thunder.png"
                )
            },
            {
                Thunder2,
            ...
            },
            {
                ...
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Cure1,
                    S_Cure,
                    "CustomImages/Checks/magic_cure.png"
                )
            },
            {
                Cure2,
            ...
            },
            {
                ...
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Reflect1,
                    S_Reflect,
                    "CustomImages/Checks/magic_reflect.png"
                )
            },
            {
                Reflect2,
            ...
            },
            {
                ...
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Magnet1,
                    S_Magnet,
                    "CustomImages/Checks/magic_magnet.png"
                )
            },
            {
                Magnet2,
            ...
            },
            {
                ...
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_TornPage1,
                    S_TornPage,
                    "CustomImages/Checks/torn_pages.png"
                )
            },
            {
                TornPage2,
            ...
            },
            {
                ...
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Valor,
                    S_Valor,
                    "CustomImages/Checks/form_valor.png"
                )
            },
            {
                Wisdom,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Wisdom,
                    S_Wisdom,
                    "CustomImages/Checks/form_wisdom.png"
                )
            },
            {
                Limit,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Limit,
                    S_Limit,
                    "CustomImages/Checks/form_limit.png"
                )
            },
            {
                Master,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Master,
                    S_Master,
                    "CustomImages/Checks/form_master.png"
                )
            },
            {
                Final,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Final,
                    S_Final,
                    "CustomImages/Checks/form_final.png"
                )
            },
            {
                Lamp,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Lamp,
                    S_Lamp,
                    "CustomImages/Checks/summon_genie.png"
                )
            },
            {
                Ukulele,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Ukulele,
                    S_Ukulele,
                    "CustomImages/Checks/summon_stitch.png"
                )
            },
            {
                Baseball,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Baseball,
                    S_Baseball,
                    "CustomImages/Checks/summon_chicken_little.png"
                )
            },
            {
                Feather,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Feather,
                    S_Feather,
                    "CustomImages/Checks/summon_peter_pan.png"
                )
            },
            {
                Nonexistence,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Nonexistence,
                    S_Nonexistence,
                    "CustomImages/Checks/proof_nonexistence.png"
                )
            },
            {
                Connection,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Connection,
                    S_Connection,
                    "CustomImages/Checks/proof_connection.png"
                )
            },
            {
                Peace,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Peace,
                    S_Peace,
                    "CustomImages/Checks/proof_peace.png"
                )
            },
            {
                PromiseCharm,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_PromiseCharm,
                    S_PromiseCharm,
                    "CustomImages/Checks/promise_charm.png"
                )
            },
            {
                OnceMore,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_OnceMore,
                    S_OnceMore,
                    "CustomImages/Checks/once_more.png"
                )
            },
            {
                SecondChance,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_SecondChance,
                    S_SecondChance,
                    "CustomImages/Checks/second_chance.png"
                )
            },
            {
                MulanWep,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_MulanWep,
                    S_MulanWep,
                    "CustomImages/Checks/lock_AncestorSword.png"
                )
            },
            {
                AuronWep,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_AuronWep,
                    S_AuronWep,
                    "CustomImages/Checks/lock_BattlefieldsofWar.png"
                )
            },
            {
                BeastWep,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_BeastWep,
                    S_BeastWep,
                    "CustomImages/Checks/lock_BeastClaw.png"
                )
            },
            {
                JackWep,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_JackWep,
                    S_JackWep,
                    "CustomImages/Checks/lock_BoneFist.png"
                )
            },
            {
                IceCream,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_IceCream,
                    S_IceCream,
                    "CustomImages/Checks/lock_IceCream.png"
                )
            },
            {
                TronWep,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_TronWep,
                    S_TronWep,
                    "CustomImages/Checks/lock_IdentityDisk.png"
                )
            },
            {
                Picture,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Picture,
                    S_Picture,
                    "CustomImages/Checks/lock_Picture.png"
                )
            },
            {
                MembershipCard,
            ...
            },
            {
                ...
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_SimbaWep,
                    S_SimbaWep,
                    "CustomImages/Checks/lock_ProudFang.png"
                )
            },
            {
                AladdinWep,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_AladdinWep,
                    S_AladdinWep,
                    "CustomImages/Checks/lock_Scimitar.png"
                )
            },
            {
                SparrowWep,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_SparrowWep,
                    S_SparrowWep,
                    "CustomImages/Checks/lock_SkillCrossbones.png"
                )
            },
            {
                HadesCup,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_HadesCup,
                    S_HadesCup,
                    "CustomImages/Checks/aux_hades_cup.png"
                )
            },
            {
                OlympusStone,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_OlympusStone,
                    S_OlympusStone,
                    "CustomImages/Checks/aux_olympus_stone.png"
                )
            },
            {
                UnknownDisk,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_UnknownDisk,
                    S_UnknownDisk,
                    "CustomImages/Checks/aux_UnknownDisk.png"
                )
            },
            {
                MunnyPouch1,
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_MunnyPouch1,
                    S_MunnyPouch,
                    "CustomImages/Checks/aux_munny_pouch.png"
                )
            },
            {
                MunnyPouch2,
            ...
            },
            {
                ...
                new Tuple<string, Item, ContentControl, string>(
                    ...
                    Ghost_Anti,
                    S_Anti,
                    "CustomImages/Checks/form_anti.png"
                )
            }
        };
        ...
        {
            {
                ...
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/ansem_report.png",
                    "Cus-G_Report1"
                )
            },
            {
            ...
            {
                Ghost_Fire1,
                new Tuple<string, string>("CustomImages/GhostChecks/magic_fire.png", "Cus-G_Fire1")
            },
            {
                Ghost_Fire2,
                new Tuple<string, string>("CustomImages/GhostChecks/magic_fire.png", "Cus-G_Fire2")
            },
            {
                Ghost_Fire3,
                new Tuple<string, string>("CustomImages/GhostChecks/magic_fire.png", "Cus-G_Fire3")
            },
            {
                Ghost_Blizzard1,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/magic_blizzard.png",
                    "Cus-G_Blizzard1"
                )
            },
            {
            ...
            },
            {
                Ghost_Thunder1,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/magic_thunder.png",
                    "Cus-G_Thunder1"
                )
            },
            {
            ...
            {
                Ghost_Cure1,
                new Tuple<string, string>("CustomImages/GhostChecks/magic_cure.png", "Cus-G_Cure1")
            },
            {
                Ghost_Cure2,
                new Tuple<string, string>("CustomImages/GhostChecks/magic_cure.png", "Cus-G_Cure2")
            },
            {
                Ghost_Cure3,
                new Tuple<string, string>("CustomImages/GhostChecks/magic_cure.png", "Cus-G_Cure3")
            },
            {
                Ghost_Reflect1,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/magic_reflect.png",
                    "Cus-G_Reflect1"
                )
            },
            {
            ...
            },
            {
                Ghost_Magnet1,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/magic_magnet.png",
                    "Cus-G_Magnet1"
                )
            },
            {
            ...
            },
            {
                Ghost_TornPage1,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/torn_pages.png",
                    "Cus-G_TornPage1"
                )
            },
            {
            ...
            {
                Ghost_Valor,
                new Tuple<string, string>("CustomImages/GhostChecks/form_valor.png", "Cus-G_Valor")
            },
            {
                Ghost_Wisdom,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/form_wisdom.png",
                    "Cus-G_Wisdom"
                )
            },
            {
                Ghost_Limit,
                new Tuple<string, string>("CustomImages/GhostChecks/form_limit.png", "Cus-G_Limit")
            },
            {
                Ghost_Master,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/form_master.png",
                    "Cus-G_Master"
                )
            },
            {
                Ghost_Final,
                new Tuple<string, string>("CustomImages/GhostChecks/form_final.png", "Cus-G_Final")
            },
            {
                Ghost_Lamp,
                new Tuple<string, string>("CustomImages/GhostChecks/summon_genie.png", "Cus-G_Lamp")
            },
            {
                Ghost_Ukulele,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/summon_stitch.png",
                    "Cus-G_Ukulele"
                )
            },
            {
                Ghost_Baseball,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/summon_chicken_little.png",
                    "Cus-G_Baseball"
                )
            },
            {
                Ghost_Feather,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/summon_peter_pan.png",
                    "Cus-G_Feather"
                )
            },
            {
                Ghost_Nonexistence,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/proof_nonexistence.png",
                    "Cus-G_Nonexistence"
                )
            },
            {
                Ghost_Connection,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/proof_connection.png",
                    "Cus-G_Connection"
                )
            },
            {
                Ghost_Peace,
                new Tuple<string, string>("CustomImages/GhostChecks/proof_peace.png", "Cus-G_Peace")
            },
            {
                Ghost_PromiseCharm,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/promise_charm.png",
                    "Cus-G_PromiseCharm"
                )
            },
            {
                Ghost_OnceMore,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/once_more.png",
                    "Cus-G_OnceMore"
                )
            },
            {
                Ghost_SecondChance,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/second_chance.png",
                    "Cus-G_SecondChance"
                )
            },
            {
                Ghost_MulanWep,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/lock_AncestorSword.png",
                    "Cus-G_MulanWep"
                )
            },
            {
                Ghost_AuronWep,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/lock_BattlefieldsofWar.png",
                    "Cus-G_AuronWep"
                )
            },
            {
                Ghost_BeastWep,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/lock_BeastClaw.png",
                    "Cus-G_BeastWep"
                )
            },
            {
                Ghost_JackWep,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/lock_BoneFist.png",
                    "Cus-G_JackWep"
                )
            },
            {
                Ghost_IceCream,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/lock_IceCream.png",
                    "Cus-G_IceCream"
                )
            },
            {
                Ghost_TronWep,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/lock_IdentityDisk.png",
                    "Cus-G_TronWep"
                )
            },
            {
                Ghost_Picture,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/lock_Picture.png",
                    "Cus-G_Picture"
                )
            },
            {
                Ghost_MembershipCard,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/lock_membershipcard.png",
                    "Cus-G_MembershipCard"
                )
            },
            {
                Ghost_SimbaWep,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/lock_ProudFang.png",
                    "Cus-G_SimbaWep"
                )
            },
            {
                Ghost_AladdinWep,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/lock_Scimitar.png",
                    "Cus-G_AladdinWep"
                )
            },
            {
                Ghost_SparrowWep,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/lock_SkillCrossbones.png",
                    "Cus-G_SparrowWep"
                )
            },
            {
                Ghost_HadesCup,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/aux_hades_cup.png",
                    "Cus-G_HadesCup"
                )
            },
            {
                Ghost_OlympusStone,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/aux_olympus_stone.png",
                    "Cus-G_OlympusStone"
                )
            },
            {
                Ghost_UnknownDisk,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/aux_UnknownDisk.png",
                    "Cus-G_UnknownDisk"
                )
            },
            {
                Ghost_MunnyPouch1,
                new Tuple<string, string>(
                    "CustomImages/GhostChecks/aux_munny_pouch.png",
                    "Cus-G_MunnyPouch1"
                )
            },
            {
            ...
            {
                Ghost_Anti,
                new Tuple<string, string>("CustomImages/GhostChecks/form_anti.png", "Cus-G_Anti")
            }
        };
    }
    ...
    private void CustomChecksCheck()
    {
        ...
        {
            checkFilesG = Directory.GetFiles(
                "CustomImages/GhostChecks/",
                "*.png",
                SearchOption.TopDirectoryOnly
            );
        }
        ...
        if (Directory.Exists("CustomImages/Worlds/Locks/"))
        {
            ...
            if (File.Exists("CustomImages/Worlds/Locks/TT3.png"))
                TwilightTownLock_1.Source = new BitmapImage(
                    new Uri(
            ...
            if (File.Exists("CustomImages/Worlds/Locks/TT2.png"))
                TwilightTownLock_2.Source = new BitmapImage(
                    new Uri(
    ...
    public void SetItemImage()
    {
        ...
        foreach (var item in Data.Items.Keys)
        {
            ...
            if (cusItemCheck[Data.Items[item].Item1].Item3 != null)
                cusItemCheck[Data.Items[item].Item1].Item3.SetResourceReference(
                    ContentProperty,
                    type + item
                );
        }
