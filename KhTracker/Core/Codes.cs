...
public class Codes
{
    ...
    public static string GetHintTextName(string worldName)
    {
        return worldName switch
        {
            ...
            "TwilightTown" => "Twilight Town",
            "HollowBastion" => "Hollow Bastion",
            "LandofDragons" => "Land of Dragons",
            "BeastsCastle" => "Beast's Castle",
            "OlympusColiseum" => "Olympus Coliseum",
            "DisneyCastle" => "Disney Castle",
            "PortRoyal" => "Port Royal",
            "HalloweenTown" => "Halloween Town",
            "PrideLands" => "Pride Lands",
            "HundredAcreWood" => "Hundred Acre Wood",
            "SpaceParanoids" => "Space Paranoids",
    ...
    {
        return ShortNames.TryGetValue(name, out var shortName) ? shortName : name;
    }

    public static string FindItemType(string name)
    {
        return ItemTypes.TryGetValue(name, out var itemType) ? itemType : "Unknown";
    }

    public static string GetTextColor(string name)
    {
        if (GetColors.TryGetValue(name, out var color))
            return color;
    ...
    {
        return ConvertItemNames.TryGetValue(name, out var itemName) ? itemName : name;
    }

    public static string ConvertSeedGenName(string name)
    {
        return ConvertOpenKh.TryGetValue(name, out var openKhSeedGenName)
            ? openKhSeedGenName
            : "Unknown";
    }
    ...
    {
        return BossTypes.Keys.Contains(name) ? BossTypes[name] : "boss_other";
    }

    //Dictionaries
    public readonly Dictionary<int, string> ItemCodes =
        new()
        {
            { 21, "Fire" },
            { 22, "Blizzard" },
    ...
    public static List<string> BossDups =
        new()
        {
            { "Hades Escape" },
            { "Hades I" },
    ...
    public static readonly Dictionary<string, string> GetColors =
        new()
        {
            { "Sora's Heart", "Pink" },
            { "Drive Forms", "Gold" },
    ...
    private readonly string[] acreWood =
    {
        "11CDFA12",
        "11CDFA1E",
        "11CDFA2A",
